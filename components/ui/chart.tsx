...
interface ChartTooltipContentProps extends React.ComponentProps<typeof TooltipContent> {
  className?: string
}

export function ChartTooltipContent({ className, ...props }: ChartTooltipContentProps) {
  return <TooltipContent {...props} className="min-w-[60px] bg-background border-border text-foreground" />
}

interface ChartTooltipTriggerProps extends React.ComponentProps<typeof TooltipTrigger> {
  className?: string
}

export function ChartTooltipTrigger({ className, ...props }: ChartTooltipTriggerProps) {
